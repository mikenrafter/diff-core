...
export function HeaderBar() {
  ...
  const {
    ...
    setRepoQuickPickOpen, repoQuickPickOpen, favoriteRepoPaths, setFavoriteRepoPaths,
  ...
  return (
      <header className="top-bar">
        ...
        <div className="top-bar-center">
          ...
          <button
            className="btn"
            onClick={() => setRepoQuickPickOpen(!repoQuickPickOpen)}
          ...
          <button
            ...
            onClick={() => {
              ...
              if (!path) return;
              setFavoriteRepoPaths(
                favoriteRepoPaths.includes(path) ? favoriteRepoPaths.filter((p) => p !== path) : [path, ...favoriteRepoPaths]
              );
            }}
