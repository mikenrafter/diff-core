...
import {
  ...
  COMPARE_TARGET_UNSTAGED,
  COMPARE_TARGET_STAGED,
...
import type {
  ...
  CompareMode,
  PersistedAppState,
  CrossFileSearchMatch,
  CrossFileSearchResult,
  FileShortStatus,
} from "./utils/constants";
import { parseSymbolEndpoint, findLineContainingSymbol } from "./utils/pathUtils";
import { formatBranchStatus, formatCompareTargetLabel } from "./utils/gitUtils";
import {
  providerSupportsToolActivity,
  buildMockActivityEntries,
  describeActivityEntry,
  summarizeActivityTimeline,
} from "./utils/activityUtils";
import { resolveInteractiveProvider, resolveInteractiveModel } from "./utils/llmUtils";
...
export default function App() {
  ...
  return (
    ...
    <div className="app">
      ...
      <HeaderBar />
      {aiSetupOpen && llmSettings && <AISetupModal />}
      {settingsOpen && llmSettings && <SettingsPanel />}
      {/* Error display */}
      {error && (
