...
| [diff-analyzer](./diff-analyzer.md) | diffcore — semantic diff review tool with ranked data-flow grouping, Tauri app + VS Code extension | Active (Phase 12 complete — 7/18 acceptance tests passed, 11 require GUI/VS Code/human review; Section 15 refinement robustness plan added) |
